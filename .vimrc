...
Plugin 'tpope/vim-fugitive' " Git wrapper package, enables :git ... to execute
" git commands from within vim and keeps a single instance of vim (for
" commits, diffs, etc.)
Plugin 'scrooloose/nerdtree' " A tree explorer plugin for vim


Plugin 'roman/golden-ratio' " Automatic resizing of Vim windows to the golden ratio
Plugin 'chiel92/vim-autoformat' " Provide easy code formatting in Vim by integrating existing code formatters
Plugin 'ntpeters/vim-better-whitespace'
Plugin 'jeffkreeftmeijer/vim-numbertoggle' " Toggle to absolute line number on inactive tabs
Plugin 'townk/vim-autoclose' " Auto closes parentheses etc.
...
Plugin 'christoomey/vim-sort-motion' " ability to sort in Vim using text objects and motions
Plugin 'tpope/vim-surround' " Allows commands in normal mode to manipulate
" enclosing paranthesis, quotes, tags, etc. e.g. 'cs{[' changes {} to []
Plugin 'tpope/vim-commentary' " gc to comment out
Plugin 'pangloss/vim-javascript' " JS syntax and indentation support
...
""""""""""""""""""""""""""""""""""""""""
Plugin 'jiangmiao/auto-pairs' " automatically handles pairs of parentheses
